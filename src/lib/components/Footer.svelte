<script lang="ts">
    ...
    $: responsiblePersonCompany = settingsData.responsible_person_company || 'Klap Web';
        ...
        <footer class="w-full h-full text-inherit">
            ...
            <div class="mt-4 text-center">
                ...
                <p class="text-inherit footer-buttonbar-p" style="font-size: var(--footer-font-size-button-bar-rem);">
                    ...
                    <a href="https://svelte.dev" target="_blank" rel="noopener noreferrer nofollow" class="hover:underline text-inherit" style="color: var(--footer-link-color);">Svelte</a>
                    &nbsp;|&nbsp;
                    <a href="https://prismic.io" target="_blank" rel="noopener noreferrer nofollow" class="hover:underline text-inherit" style="color: var(--footer-link-color);">Prismic</a>
                </p>
