...
<Bounded
	...
	marginTopSize={primary.margin_top}
...
>
	...
	<div
		class="flex flex-wrap {layout === 'Vertikal'
			? 'flex-col items-start'
			: (alignClass[align] ?? 'justify-center')} gap-3"
		style={layout === 'Vertikal'
			? `align-items: ${align === 'Rechts' ? 'flex-end' : align === 'Mitte' ? 'center' : 'flex-start'}`
			: ''}
	>
		{#each slice.items as item}
			...
			<a
				...
				class="kontakt-btn inline-flex items-center rounded-full font-semibold transition-opacity hover:opacity-85 {sizeClass[
					buttonSize
				] ?? sizeClass['Mittel']}"
			...
			>
				...
				{:else if item.app === 'Telefon'}
					...
					>
						<path
							d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.41 2 2 0 0 1 3.6 1.21h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.76a16 16 0 0 0 6 6l.96-.96a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"
						/>
					</svg>
				...
				{:else if item.app === 'Facebook Messenger'}
					<svg width={sz} height={sz} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
						<path
							d="M12 0C5.373 0 0 4.975 0 11.111c0 3.497 1.745 6.616 4.472 8.652V24l4.086-2.242c1.09.301 2.246.464 3.442.464 6.627 0 12-4.975 12-11.111S18.627 0 12 0zm1.193 14.963l-3.056-3.259-5.963 3.259L10.986 8.4l3.137 3.259L19.949 8.4z"
						/>
					</svg>
