...
<SliceZone
	...
	{components}
	context={{ baseCurrency: data.baseCurrency, globalDepositPct: data.globalDepositPct ?? null, plaeneData: data.plaeneData ?? {}, pageLeistungen: data.page.data.leistungen ?? [] }}
/>
